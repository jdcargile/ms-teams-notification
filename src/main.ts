...
async function run(): Promise<void> {
  try {
	...
	const messageCard = createMessageCard(notificationSummary, commit, repo, author, runNum, runId, eventName, branchUrl, repoName, sha, repoUrl, timestamp);

	axios.post(msTeamsWebhookUri, messageCard)
